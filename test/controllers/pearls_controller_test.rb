...
class PearlsControllerTest < ActionController::TestCase
  ...
  test "should create pearl" do
    assert_difference('Pearl.count') do
      post :create, pearl: { body: @pearl.body, image: @pearl.image, title: @pearl.title, user_id: @pearl.user_id }
    end
  ...
  test "should update pearl" do
    patch :update, id: @pearl, pearl: { body: @pearl.body, image: @pearl.image, title: @pearl.title, user_id: @pearl.user_id }
    assert_redirected_to pearl_path(assigns(:pearl))
  end
